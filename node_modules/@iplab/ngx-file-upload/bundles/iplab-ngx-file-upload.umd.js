(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FileUploadComponent = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild('labelRef', { static: true }),
            __metadata("design:type", core.ElementRef)
        ], FileUploadComponent.prototype, "label", void 0);
        __decorate([
            core.HostBinding('class.has-files'),
            __metadata("design:type", Boolean),
            __metadata("design:paramtypes", [])
        ], FileUploadComponent.prototype, "hasFiles", null);
        __decorate([
            core.HostBinding('class.ng-invalid'),
            __metadata("design:type", Boolean),
            __metadata("design:paramtypes", [])
        ...
        FileUploadComponent = FileUploadComponent_1 = __decorate([
            core.Component({
                ...
                providers: [
                    FileUploadService,
                    {
                        ...
                        useExisting: core.forwardRef(function () { return FileUploadComponent_1; }),
                        multi: true
                    }
                ],
            ...
            __metadata("design:paramtypes", [FileUploadService,
                core.ElementRef,
                core.Renderer2, Object, core.ChangeDetectorRef])
        ], FileUploadComponent);
    ...
    var FileUploadListItemComponent = /** @class */ (function () {
        ...
        FileUploadListItemComponent = __decorate([
            core.Component({
    ...
    var SimpleFileUploadComponent = /** @class */ (function (_super) {
        ...
        SimpleFileUploadComponent_1 = SimpleFileUploadComponent;
        ...
        SimpleFileUploadComponent = SimpleFileUploadComponent_1 = __decorate([
            core.Component({
                ...
                providers: [
                    ...
                    {
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return SimpleFileUploadComponent_1; }),
                        multi: true
                    }
                ],
                changeDetection: core.ChangeDetectionStrategy.OnPush,
        ...
        FileSizeValidator = FileSizeValidator_1 = __decorate([
            core.Directive({
                ...
                providers: [{
                        ...
                        useExisting: core.forwardRef(function () { return FileSizeValidator_1; }),
                        multi: true
                    }],
                host: {
    ...
    var FilesLimitValidator = /** @class */ (function () {
        ...
        FilesLimitValidator = FilesLimitValidator_1 = __decorate([
            core.Directive({
                ...
                providers: [{
                        provide: forms.NG_VALIDATORS,
                        useExisting: core.forwardRef(function () { return FilesLimitValidator_1; }),
                        multi: true
                    }],
    ...
    var FilesAcceptValidator = /** @class */ (function () {
        ...
        FilesAcceptValidator = FilesAcceptValidator_1 = __decorate([
            core.Directive({
                ...
                providers: [{
                        provide: forms.NG_VALIDATORS,
                        useExisting: core.forwardRef(function () { return FilesAcceptValidator_1; }),
                        multi: true
                    }],
    ...
    var FilesAcceptDirective = /** @class */ (function () {
        ...
        FilesAcceptDirective = __decorate([
            ...
            __param(0, core.Optional()), __param(0, core.Host()), __param(0, core.Self()),
            __param(1, core.Optional()), __param(1, core.Host()), __param(1, core.Self()),
