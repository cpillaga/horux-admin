...
export declare class FileUploadAttributeComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    private onTouch;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<FileUploadAttributeComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<FileUploadAttributeComponent, "[file-drop-zone]", never, { "control": "control"; }, {}, ["templateRef"], ["*"]>;
}
