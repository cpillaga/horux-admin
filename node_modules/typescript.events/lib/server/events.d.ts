...
export declare class Event {
    ...
    private _registerEvent(eventName, listener, type);
    private _createListeners(listener, listeners?);
    private _createOnceListener(listener, eventName);
    private _ListenerLimitReached(eventName);
}
